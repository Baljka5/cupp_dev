...
class StoreConsultant(m.Model):
    ...
    up_frz_ice = m.IntegerField('Horizontal icemark freezer', blank=True, null=True, default=0)
    ser_storabox = m.BooleanField('Stora Box', blank=True, null=True, default=0)
    ser_Umoney = m.BooleanField('Автобусны карт цэнэглэгчтэй эсэх', blank=True, null=True, default=0)
    ser_pow_bank = m.BooleanField('Зөөврийн цэнэглэгч түрээс', blank=True, null=True, default=0)
    ser_lottery = m.BooleanField('Сугалаа', blank=True, null=True, default=0)
    ser_delivery = m.BooleanField('Хүргэлт', blank=True, null=True, default=0)
    ser_print = m.BooleanField('Хэвлэл', blank=True, null=True, default=0)
    ser_ticket = m.BooleanField('Тасалбар', blank=True, null=True, default=0)
    ...
    squat_toilet_yn = m.BooleanField('Дэлгүүрийн гадна модон 00 той эсэх', blank=True, null=True, default=0)
